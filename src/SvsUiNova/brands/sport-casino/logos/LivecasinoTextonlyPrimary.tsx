...
export interface LivecasinoTextonlyPrimaryProps extends SVGProps<SVGSVGElement> {
  /**
...
/**
 * LivecasinoTextonlyPrimary - Sport & Casino logo
 *
 * Generated from: livecasino-textonly-primary.svg
 */
export const LivecasinoTextonlyPrimary = forwardRef<SVGSVGElement, LivecasinoTextonlyPrimaryProps>(
