...
export interface VectorProps extends SVGProps<SVGSVGElement> {
  /**
...
/**
 * Vector - Sport & Casino logo
 *
 * Generated from: vector.svg
 */
export const Vector = forwardRef<SVGSVGElement, VectorProps>(
