...
export interface LivecasinoTextonlyProps extends SVGProps<SVGSVGElement> {
  /**
...
/**
 * LivecasinoTextonly - Sport & Casino logo
 *
 * Generated from: livecasino-textonly.svg
 */
export const LivecasinoTextonly = forwardRef<SVGSVGElement, LivecasinoTextonlyProps>(
